  ...
  <AppLayout>
    ...
    <Teleport to="body">
      <div
        ...
        ref="dropdownRef"
        class="animate-in fade-in slide-in-from-top-2 fixed z-[100000020] w-max max-w-[calc(100vw-16px)] overflow-hidden rounded-lg border border-gray-200 bg-white duration-200 sm:min-w-[380px] dark:border-dark-700 dark:bg-dark-800"
