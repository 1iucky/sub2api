  ...
  <AppLayout>
    <div class="custom-page-layout">
      <div class="card flex-1 min-h-0 overflow-hidden">
        ...
        <div
          v-else-if="!menuItem"
          class="flex h-full items-center justify-center bg-blueprint p-10 text-center"
        >
          <div class="max-w-md">
            <div
              class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-800"
            >
              <Icon name="link" size="lg" class="text-gray-400 dark:text-dark-400" />
            </div>
            <p class="eyebrow mb-1">{{ t('customPage.notFoundTitle') }}</p>
        ...
        <!-- URL not configured -->
        <div v-else-if="!isValidUrl" class="flex h-full items-center justify-center bg-blueprint p-10 text-center">
          <div class="max-w-md">
            <div
              class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full border border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-800"
            >
            ...
            <p class="eyebrow mb-1">{{ t('customPage.notConfiguredTitle') }}</p>
            <p class="mt-2 text-sm text-gray-500 dark:text-dark-400">
...
.toc-sidebar {
  @apply flex flex-col h-full border-r border-gray-200 dark:border-dark-700 bg-white dark:bg-dark-900;
  width: min(240px, 30%);
  min-width: 160px;
  max-width: 280px;
  overflow: hidden;
...
@media (max-width: 640px) {
  ...
  :global(.dark) .toc-sidebar {
    border-right-color: theme('colors.dark.700');
  }
}
...
.toc-title {
  @apply font-mono text-xs uppercase tracking-wide text-gray-500 dark:text-dark-400;
}

.toc-close-btn {
  @apply p-1 rounded-sm text-gray-400 hover:text-gray-600 dark:hover:text-dark-200 hover:bg-gray-100 dark:hover:bg-dark-800 transition-colors;
}
...
.toc-item {
  @apply block px-2 py-1.5 text-sm rounded-sm transition-colors duration-150 truncate;
  @apply text-gray-600 dark:text-dark-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-dark-800;
}

.toc-item.toc-active {
  @apply text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-500/10 font-medium;
}
...
.toc-toggle-btn {
  @apply absolute left-2 top-2 z-10 flex items-center px-2 py-1.5 rounded-sm text-sm;
  @apply bg-white dark:bg-dark-900 border border-gray-200 dark:border-dark-700;
  @apply text-gray-600 dark:text-dark-300 hover:bg-gray-100 dark:hover:bg-dark-800;
...
.custom-open-fab {
  ...
  @apply bg-white/95 dark:bg-dark-900/95;
}
...
.markdown-page-content h1 { @apply text-3xl font-normal tracking-tight mt-8 mb-4 pb-2 border-b border-dashed border-gray-200 dark:border-dark-700; }
.markdown-page-content h2 { @apply text-2xl font-normal tracking-tight mt-6 mb-3; }
.markdown-page-content h3 { @apply text-xl font-medium tracking-tight mt-5 mb-2; }
.markdown-page-content h4 { @apply text-lg font-medium tracking-tight mt-4 mb-2; }
...
.markdown-page-content blockquote { @apply border-l-2 border-gray-300 dark:border-dark-600 pl-4 italic text-gray-600 dark:text-dark-300 my-4; }
...
.markdown-page-content th { @apply border border-gray-200 dark:border-dark-700 px-3 py-2 bg-gray-50 dark:bg-dark-900 font-mono font-medium uppercase tracking-wide text-xs text-left text-gray-600 dark:text-dark-300; }
.markdown-page-content td { @apply border border-gray-200 dark:border-dark-700 px-3 py-2; }
.markdown-page-content code { @apply bg-gray-100 dark:bg-dark-800 px-1.5 py-0.5 rounded-sm text-sm font-mono; }
.markdown-page-content pre { @apply bg-dark-950 text-gray-100 p-4 rounded-md overflow-x-auto my-4 relative; }
.markdown-page-content pre code { @apply bg-transparent p-0 text-inherit; }
.markdown-page-content hr { @apply my-6 border-t border-dashed border-gray-200 dark:border-dark-700; }
...
.copy-btn:hover { background: theme('colors.dark.700'); }
.markdown-page-content pre:hover .copy-btn { opacity: 1; }
</style>
