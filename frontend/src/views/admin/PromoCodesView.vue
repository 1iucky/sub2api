        ...
        >
          <template #cell-code="{ value }">
            <div class="flex items-center space-x-2">
              <code class="font-mono text-sm tabular-nums text-gray-900 dark:text-gray-100">{{ value }}</code>
              <button
          ...
          <template #cell-bonus_amount="{ value }">
            <span class="font-mono text-sm font-medium tabular-nums text-primary-600 dark:text-primary-400">
              ${{ value.toFixed(2) }}
            </span>
          </template>

          <template #cell-usage="{ row }">
            <span class="font-mono text-sm tabular-nums text-gray-600 dark:text-gray-300">
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center space-x-1">
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-sm p-1.5 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 dark:hover:bg-dark-600 dark:hover:text-gray-300"
                :title="t('common.edit')"
              >
    ...
    >
      ...
      <div v-else class="space-y-3">
        <div
          ...
          :key="usage.id"
          class="flex items-center justify-between rounded-md border border-gray-200 p-3 dark:border-dark-700"
        >
          <div class="flex items-center gap-3">
            <div class="flex h-8 w-8 items-center justify-center rounded-sm bg-gray-100 dark:bg-dark-700/60">
              <Icon name="user" size="sm" class="text-gray-600 dark:text-gray-300" />
            </div>
            <div>
          ...
          <div class="text-right">
            <span class="font-mono text-sm font-medium tabular-nums text-emerald-600 dark:text-emerald-400">
