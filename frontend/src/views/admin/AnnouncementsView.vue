        ...
        >
          <template #cell-title="{ value, row }">
            <div class="min-w-0">
              ...
              <div class="mt-1 flex items-center gap-2 font-mono text-xs tabular-nums text-gray-500 dark:text-dark-400">
                <span>#{{ row.id }}</span>
          ...
          <template #cell-timeRange="{ row }">
            <div class="font-mono text-xs tabular-nums text-gray-600 dark:text-gray-300">
              <div>
                <span class="uppercase tracking-wide text-gray-400 dark:text-dark-400">{{ t('admin.announcements.form.startsAt') }}:</span>
                <span class="ml-1">{{ row.starts_at ? formatDateTime(row.starts_at) : t('admin.announcements.timeImmediate') }}</span>
              </div>
              <div class="mt-0.5">
                <span class="uppercase tracking-wide text-gray-400 dark:text-dark-400">{{ t('admin.announcements.form.endsAt') }}:</span>
