...
<template>
  <BaseDialog :show="show" :title="modalTitle" width="full" @close="close">
    <div class="flex h-full min-h-0 flex-col">
      <!-- Filters -->
      <div class="mb-4 flex-shrink-0 border-b border-dashed border-gray-200 pb-4 dark:border-dark-700">
        <div class="grid grid-cols-2 gap-2 md:grid-cols-8">
          <div class="col-span-2 compact-select">
            <div class="relative group">
              ...
              <input
                v-model="q"
                type="text"
                class="w-full rounded-sm border border-gray-200 bg-white py-1.5 pl-9 pr-3 font-mono text-xs text-gray-700 transition-colors placeholder:text-gray-400 focus:border-primary-500 focus:bg-white dark:border-dark-700 dark:bg-dark-900 dark:text-gray-300 dark:focus:bg-dark-800"
          ...
          <div class="flex items-center justify-end">
            <button type="button" class="rounded-sm border border-gray-200 bg-white px-3 py-1.5 font-mono text-xs font-medium text-gray-700 transition-colors hover:bg-gray-100 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-300 dark:hover:bg-dark-700" @click="resetFilters">
              {{ t('common.reset') }}
            </button>
          </div>
        </div>
      ...
      <div class="flex min-h-0 flex-1 flex-col">
        <div class="mb-2 flex-shrink-0 font-mono text-xs tabular-nums text-gray-500 dark:text-gray-400">
...
.compact-select .select-trigger {
  @apply py-1.5 px-3 text-xs rounded-sm;
}
</style>
