  ...
  <div class="flex h-full flex-col rounded-lg border border-gray-200 bg-white p-6 dark:border-dark-700 dark:bg-dark-900">
    <div class="mb-4 flex shrink-0 items-center justify-between">
      ...
      <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
        ...
        <span class="flex items-center gap-1"><span class="h-2 w-2 rounded-full bg-emerald-500"></span>{{ t('admin.ops.tpsK') }}</span>
        <template v-if="!props.fullscreen">
          <button
            type="button"
            class="ml-2 inline-flex items-center rounded-sm border border-gray-200 bg-white px-2 py-1 font-mono text-[11px] font-medium text-gray-700 transition-colors hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-50 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-300 dark:hover:bg-dark-700"
