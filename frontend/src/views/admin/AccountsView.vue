              ...
              <div class="relative" ref="accountToolsDropdownRef">
                ...
                <Teleport to="body">
                  <div
                    ...
                    class="fixed z-[9999] origin-top-right overflow-hidden rounded-md border border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-900"
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-rate_multiplier="{ row }">
            <span class="inline-flex items-center gap-1 font-mono text-sm tabular-nums text-gray-700 dark:text-gray-300">
