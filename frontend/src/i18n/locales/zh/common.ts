export default {
  ...
  auth: {
    ...
    createAccount: '创建账户',
    signUpToStart: '开通账户以接入 {siteName} 网关。',
    signUp: '注册',
    processing: '处理中...',
    continue: '继续',
    rememberMe: '记住我',
    ...
    registrationDisabled: '账户开通已关闭，请联系管理员获取访问权限。',
    emailLabel: '邮箱',
    ...
    loginSuccess: '认证成功，网关会话已激活。',
    accountCreatedSuccess: '账户已开通，欢迎使用 {siteName}。',
    ...
    resendCode: '重新发送验证码',
    sendCodeDesc: '正在向以下邮箱发送验证码',
    codeSentSuccess: '验证码已发送，请查收邮箱。',
    verifying: '验证中...',
    verifyAndCreate: '验证并开通账户',
    ...
    passwordResetSuccessHint: '密码已更新，可使用新凭据登录。',
    invalidResetLink: '无效的重置链接',
    invalidResetLinkHint: '此重置链接无效或已过期，请重新请求以继续。',
    requestNewResetLink: '请求新的重置链接',
    invalidOrExpiredToken: '此密码重置链接无效或已过期，请重新请求以继续。'
  },
