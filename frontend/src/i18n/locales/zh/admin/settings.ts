export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 SiliconBase 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 SiliconBase 用户登录',
      ...
      site: {
        ...
        customerServiceInviteURL: '客服群邀请地址',
        customerServiceInviteURLPlaceholder: 'https://example.com/support-group',
        customerServiceInviteURLHint: '配置后，控制台顶部“联系客服”图标会直接打开该地址。',
        docUrl: '文档链接',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: '添加当前易支付服务商额外支持的支付方式。支付方式会记录到 SiliconBase 订单中，上游 type 会作为易支付 type 参数提交。',
