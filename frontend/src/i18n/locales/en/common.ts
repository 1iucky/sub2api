export default {
  ...
  // Auth
  auth: {
    welcomeBack: 'Sign in to SiliconBase',
    signInToAccount: 'Authenticate to route requests through your gateway.',
    signIn: 'Sign In',
    ...
    signUpToStart: 'Provision an account to access the {siteName} gateway.',
    signUp: 'Sign up',
    processing: 'Processing...',
    continue: 'Continue',
    ...
    registrationDisabled: 'Account provisioning is disabled. Contact the administrator for access.',
    emailLabel: 'Email',
    ...
    loginSuccess: 'Authenticated. Gateway session active.',
    accountCreatedSuccess: 'Account provisioned. Welcome to {siteName}.',
    ...
    sendCodeDesc: 'Sending a verification code to',
    codeSentSuccess: 'Verification code dispatched. Check your inbox.',
    verifying: 'Verifying...',
    verifyAndCreate: 'Verify & Provision Account',
    ...
    forgotPasswordHint: 'Enter your email to receive a password reset link.',
    sendResetLink: 'Send Reset Link',
    sendingResetLink: 'Sending...',
    sendResetLinkFailed: 'Failed to send reset link. Please try again.',
    resetEmailSent: 'Reset Link Sent',
    resetEmailSentHint: 'If an account exists for this email, a reset link is on its way. Check your inbox and spam folder.',
    backToLogin: 'Back to Login',
    ...
    passwordResetSuccessHint: 'Password updated. Sign in with your new credentials.',
    invalidResetLink: 'Invalid Reset Link',
    invalidResetLinkHint: 'This reset link is invalid or expired. Request a new one to continue.',
    requestNewResetLink: 'Request New Reset Link',
    invalidOrExpiredToken: 'This password reset link is invalid or expired. Request a new one to continue.'
  },
