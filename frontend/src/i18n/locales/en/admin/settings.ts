export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for SiliconBase end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for SiliconBase end-user login',
      ...
      site: {
        ...
        customerServiceInviteURL: 'Support Group Invite URL',
        customerServiceInviteURLPlaceholder: 'https://example.com/support-group',
        customerServiceInviteURLHint: 'When configured, the top-bar contact support icon opens this URL directly.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on SiliconBase orders; the upstream type is sent as EasyPay type.',
