<template>
  <BaseDialog :show="show" :title="t('admin.users.userApiKeys')" width="wide" @close="handleClose">
    <div v-if="user" class="space-y-4">
      ...
      <div v-else ref="scrollContainerRef" class="max-h-96 space-y-3 overflow-y-auto" @scroll="closeGroupSelector">
        <div v-for="key in apiKeys" :key="key.id" class="rounded-md border border-gray-200 bg-white p-4 dark:border-dark-700 dark:bg-dark-800">
          ...
          <div class="mt-3 flex flex-wrap gap-4 text-xs text-gray-500">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                class="-mx-1 -my-0.5 flex cursor-pointer items-center gap-1 rounded-sm px-1 py-0.5 transition-colors hover:bg-gray-100 dark:hover:bg-dark-700"
  ...
  <Teleport to="body">
    <div
      ...
      ref="dropdownRef"
      class="animate-in fade-in slide-in-from-top-2 fixed z-[100000020] w-64 overflow-hidden rounded-lg border border-gray-200 bg-white duration-200 dark:border-dark-700 dark:bg-dark-800"
