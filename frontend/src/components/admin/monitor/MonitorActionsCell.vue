<template>
  <div class="flex items-center gap-1">
    <button
      @click="$emit('run', row)"
      :disabled="running"
      class="flex flex-col items-center gap-0.5 rounded-sm p-1.5 font-mono uppercase tracking-wide text-gray-500 transition-colors hover:bg-gray-100 hover:text-primary-600 dark:hover:bg-dark-800 dark:hover:text-primary-400"
    >
    ...
    <button
      ...
      class="flex flex-col items-center gap-0.5 rounded-sm p-1.5 font-mono uppercase tracking-wide text-gray-500 transition-colors hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20 dark:hover:text-red-400"
    >
