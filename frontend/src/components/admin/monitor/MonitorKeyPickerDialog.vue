<template>
  ...
  >
    <div class="space-y-3">
      ...
      <div v-else class="max-h-96 overflow-auto rounded-md border border-gray-200 dark:border-dark-700">
        <table class="w-full text-sm">
          <thead class="sticky top-0 z-10 bg-gray-50 dark:bg-dark-900">
            <tr class="text-left text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
              <th class="border-b border-dashed border-gray-200 px-3 py-2 font-mono dark:border-dark-700">{{ t('common.name') }}</th>
              <th class="border-b border-dashed border-gray-200 px-3 py-2 font-mono dark:border-dark-700">{{ t('keys.apiKey') }}</th>
              <th class="border-b border-dashed border-gray-200 px-3 py-2 font-mono dark:border-dark-700">{{ t('keys.group') }}</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-dashed divide-gray-200 dark:divide-dark-700">
            ...
            >
              ...
              <td class="px-3 py-2 font-mono text-xs tabular-nums text-gray-500 dark:text-gray-400">{{ maskApiKey(k.key) }}</td>
              <td class="px-3 py-2">
                <GroupBadge
                  v-if="k.group"
                  :name="k.group.name"
