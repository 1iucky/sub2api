<template>
  ...
  >
    <div class="space-y-6">
      ...
      <div
        v-if="account"
        class="flex items-center justify-between rounded-md border border-gray-200 bg-gray-50 p-3 dark:border-dark-700 dark:bg-dark-900"
      >
        <div class="flex items-center gap-3">
          <div
            class="flex h-10 w-10 items-center justify-center rounded-sm border border-primary-200 bg-primary-50 text-primary-600 dark:border-primary-500/30 dark:bg-primary-500/10 dark:text-primary-400"
          >
            <Icon name="chartBar" size="md" />
          </div>
          <div>
            <div class="font-normal tracking-tight text-gray-900 dark:text-gray-100">{{ account.name }}</div>
        ...
        <span
          :class="[
            'inline-flex items-center rounded-sm border px-2.5 py-1 font-mono text-xs font-medium uppercase tracking-wide',
            account.status === 'active'
              ? 'border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-400'
              : 'border-gray-200 bg-gray-50 text-gray-600 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400'
          ]"
        >
          {{ account.status }}
        </span>
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <!-- 30-Day Total Cost -->
          <div
            class="card border-l-2 border-l-primary-500 p-4"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="eyebrow">{{
                t('admin.accounts.stats.totalCost')
              }}</span>
              <div class="rounded-sm border border-primary-200 bg-primary-50 p-1.5 text-primary-600 dark:border-primary-500/30 dark:bg-primary-500/10 dark:text-primary-400">
                <Icon name="dollar" size="sm" />
              </div>
            </div>
            <p class="font-mono text-2xl font-normal tabular-nums text-primary-600 dark:text-primary-400">
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-sm border border-gray-200 bg-gray-50 p-1.5 text-gray-500 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-400">
                <Icon name="bolt" size="sm" />
              </div>
            </div>
            <p class="font-mono text-2xl font-normal tabular-nums text-gray-900 dark:text-white">
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              ...
              <span class="text-sm font-normal tracking-tight text-gray-900 dark:text-white">{{
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                ...
                <span class="font-mono text-sm tabular-nums text-gray-900 dark:text-white"
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center justify-between">
                <span class="text-xs text-gray-500 dark:text-gray-400">{{ t('usage.accountBilled') }}</span>
                <span class="font-mono text-sm tabular-nums text-primary-600 dark:text-primary-400"
        ...
        <!-- Usage Trend Chart -->
        <div class="card p-4">
          <h3 class="mb-4 text-sm font-normal tracking-tight text-gray-900 dark:text-white">
