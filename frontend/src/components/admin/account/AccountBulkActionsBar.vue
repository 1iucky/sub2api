<template>
  <div class="mb-4 flex items-center justify-between rounded-md border border-primary-200 bg-primary-50/60 p-3 dark:border-primary-800 dark:bg-primary-900/10">
    <div class="flex flex-wrap items-center gap-2">
      <span v-if="selectedIds.length > 0" class="inline-flex items-center gap-2 text-sm text-gray-700 dark:text-gray-200">
        ...
        <span class="font-mono text-sm tabular-nums font-medium text-primary-700 dark:text-primary-300">
          {{ selectedIds.length }}
        </span>
      </span>
