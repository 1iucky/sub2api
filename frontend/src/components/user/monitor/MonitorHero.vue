<template>
  <section class="py-3 md:py-4">
    <div class="flex items-center justify-end gap-3 flex-wrap">
      <div
        role="tablist"
        class="inline-flex p-0.5 rounded-md bg-gray-100 dark:bg-dark-800 border border-gray-200 dark:border-dark-700 text-xs"
      >
        <button
          ...
          class="px-3 py-1 rounded-sm font-mono uppercase tracking-wide transition-colors duration-150"
      ...
      <span
        class="inline-flex items-center px-2.5 py-1 rounded-sm text-xs font-mono tracking-wide uppercase border"
      ...
      <button
        type="button"
        class="h-8 w-8 rounded-sm flex items-center justify-center text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-dark-800 transition-colors duration-150 border border-transparent hover:border-gray-300 dark:hover:border-dark-600 disabled:opacity-50"
        :disabled="loading"
