<template>
  <div class="mt-4 pt-3 border-t border-gray-200 dark:border-dark-700">
    <div
      class="flex justify-between text-[10px] font-mono uppercase tracking-wide text-gray-500 dark:text-dark-400 mb-2"
    >
    ...
    <div
      v-if="maintenance"
      class="flex h-5 w-full items-center justify-center rounded-sm border border-dashed border-gray-300 dark:border-dark-600 text-[10px] font-mono uppercase tracking-wide text-gray-500 dark:text-dark-400"
    >
    ...
    <div
      class="mt-1 flex justify-between text-[9px] font-mono uppercase tracking-wide text-gray-400 dark:text-dark-400"
    >
