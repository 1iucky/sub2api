<template>
  <div v-if="rows.length > 0" class="space-y-2">
    ...
    >
      ...
      <button
        type="button"
        class="rounded-sm p-2 text-red-500 transition-colors hover:text-red-600 dark:hover:text-red-400"
  ...
  <button
    type="button"
    class="w-full rounded-sm border-2 border-dashed border-gray-300 px-4 py-2 text-gray-600 transition-colors hover:border-gray-400 hover:text-gray-700 dark:border-dark-500 dark:text-gray-400 dark:hover:border-dark-400 dark:hover:text-gray-300"
    @click="addRow"
  >
