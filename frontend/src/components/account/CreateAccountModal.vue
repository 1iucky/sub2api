<template>
  ...
  >
    ...
    <div v-if="isOAuthFlow" class="mb-6 flex items-center justify-center">
      <div class="flex items-center gap-3">
        <div class="flex items-center">
          ...
          <span class="ml-2 font-mono text-xs uppercase tracking-wide text-gray-700 dark:text-gray-300">{{
            t('admin.accounts.oauth.authMethod')
          }}</span>
        </div>
        <div class="h-px w-8 bg-gray-300 dark:bg-dark-600" />
        <div class="flex items-center">
          <div
            :class="[
              'flex h-7 w-7 items-center justify-center rounded-sm border font-mono text-xs transition-colors',
    ...
    >
      ...
      <div>
        ...
        <div class="mt-2 flex flex-wrap rounded-md border border-gray-200 bg-gray-50 p-1 dark:border-dark-700 dark:bg-dark-900" data-tour="account-form-platform">
          <button
            type="button"
            @click="form.platform = 'anthropic'"
            :class="[
              'flex flex-1 items-center justify-center gap-2 rounded-sm px-4 py-2.5 text-sm font-medium transition-colors',
              form.platform === 'anthropic'
                ? 'border border-primary-500 bg-white text-primary-700 dark:bg-dark-800 dark:text-primary-400'
      ...
      <div v-if="form.platform === 'anthropic'">
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-gray-200 hover:border-orange-400 dark:border-dark-700 dark:hover:border-orange-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'apikey'
                ...
                : 'border-gray-200 hover:border-purple-400 dark:border-dark-700 dark:hover:border-purple-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'bedrock'
                ...
                : 'border-gray-200 hover:border-amber-400 dark:border-dark-700 dark:hover:border-amber-700'
            ]"
          >
            <div
              :class="[
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'service_account'
                ...
                : 'border-gray-200 hover:border-sky-400 dark:border-dark-700 dark:hover:border-sky-700'
            ]"
          >
            <div
              :class="[
        ...
        <div
          ...
          class="mt-3 rounded-md border border-sky-200 bg-sky-50 px-3 py-2 text-xs text-sky-800 dark:border-sky-800/40 dark:bg-sky-900/20 dark:text-sky-200"
        >
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-gray-200 hover:border-green-400 dark:border-dark-700 dark:hover:border-green-700'
            ]"
          >
            <div
              :class="[
      ...
      <div v-if="form.platform === 'gemini'">
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            class="flex items-center gap-1 rounded-sm border border-blue-200 px-2 py-1 font-mono text-xs text-blue-600 transition-colors hover:bg-blue-50 dark:border-blue-800/40 dark:text-blue-400 dark:hover:bg-blue-900/20"
          >
          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-gray-200 hover:border-blue-400 dark:border-dark-700 dark:hover:border-blue-700'
            ]"
          >
            <div
              :class="[
        ...
        <div
          ...
          class="mt-3 rounded-md border border-purple-200 bg-purple-50 px-3 py-2 text-xs text-purple-800 dark:border-purple-800/40 dark:bg-purple-900/20 dark:text-purple-200"
        >
        ...
        <div v-if="accountCategory === 'oauth-based'" class="mt-4">
          ...
          <div class="mt-2 grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded-sm border border-purple-200 px-1.5 py-0.5 font-mono text-[10px] font-medium uppercase tracking-wide text-purple-700 dark:border-purple-800/40 dark:bg-purple-900/40 dark:text-purple-300"
                  >
                    {{ t('admin.accounts.gemini.oauthType.badges.individuals') }}
                  </span>
                  <span
                    class="rounded-sm border border-emerald-200 px-1.5 py-0.5 font-mono text-[10px] font-medium uppercase tracking-wide text-emerald-700 dark:border-emerald-800/40 dark:bg-emerald-900/40 dark:text-emerald-300"
                  >
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded-sm border border-blue-200 px-1.5 py-0.5 font-mono text-[10px] font-medium uppercase tracking-wide text-blue-700 dark:border-blue-800/40 dark:bg-blue-900/40 dark:text-blue-300"
                  >
          ...
          <div class="mt-3">
            <button
              ...
              class="flex items-center gap-2 font-mono text-xs uppercase tracking-wide text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-200"
            >
              <svg
          ...
          <div v-if="showAdvancedOAuth" class="mt-3 group relative">
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  <span
                    class="rounded-sm border border-amber-200 px-1.5 py-0.5 font-mono text-[10px] font-medium uppercase tracking-wide text-amber-700 dark:border-amber-800/40 dark:bg-amber-900/40 dark:text-amber-300"
                  >
              ...
              <span
                ...
                class="ml-auto shrink-0 rounded-sm border border-amber-200 px-2 py-0.5 font-mono text-[10px] uppercase tracking-wide text-amber-700 dark:border-amber-800/40 dark:bg-amber-900/30 dark:text-amber-300"
              >
      ...
      <div v-if="(form.platform === 'gemini' || form.platform === 'anthropic') && accountCategory === 'service_account'" class="space-y-4">
        <div>
          ...
          <div
            :class="[
              'rounded-md border border-dashed px-4 py-5 transition-colors',
              vertexServiceAccountDragActive
                ? 'border-primary-500 bg-primary-50 dark:border-primary-500 dark:bg-primary-500/10'
                : 'border-gray-300 bg-gray-50 hover:border-primary-400 hover:bg-primary-50/60 dark:border-dark-600 dark:bg-dark-800/40 dark:hover:border-primary-600 dark:hover:bg-primary-500/10'
            ]"
          ...
          >
            ...
            <div
              ...
              class="mt-3 rounded-md border border-gray-200 bg-white px-3 py-2 font-mono text-xs text-gray-700 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-300"
            >
      ...
      <div v-if="form.platform === 'antigravity'" class="border-t border-gray-200 pt-4 dark:border-dark-700">
        <label class="input-label">{{ t('admin.accounts.modelRestriction') }}</label>

        <!-- Mapping Mode Only (no toggle for Antigravity) -->
        <div>
          <div class="mb-3 rounded-md border border-purple-200 bg-purple-50 p-3 dark:border-purple-800/40 dark:bg-purple-900/20">
            ...
            >
              <div class="flex items-center gap-2">
                ...
                <button
                  ...
                  class="rounded-sm p-2 text-red-500 transition-colors hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-900/20"
                >
          ...
          <button
            ...
            class="mb-3 w-full rounded-sm border border-dashed border-gray-300 px-4 py-2 font-mono text-xs uppercase tracking-wide text-gray-600 transition-colors hover:border-gray-400 hover:text-gray-700 dark:border-dark-600 dark:text-gray-400 dark:hover:border-dark-500 dark:hover:text-gray-300"
          >
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              :class="['rounded-sm px-2.5 py-1 font-mono text-xs transition-colors', preset.color]"
            >
              + {{ preset.label }}
            </button>
          </div>
        ...
        <div class="mt-2 flex gap-4">
          <label class="flex cursor-pointer items-center">
            <input
              ...
              type="radio"
              value="oauth"
              class="mr-2 text-primary-600 focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500"
            />
      ...
      <div v-if="form.type === 'apikey' && form.platform !== 'antigravity'" class="space-y-4">
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-dark-700">
          ...
          <div
            ...
            class="mb-3 rounded-md border border-amber-200 bg-amber-50 p-3 dark:border-amber-800/40 dark:bg-amber-900/20"
          >
              ...
              <button
                ...
                :class="[
                  ...
                  modelRestrictionMode === 'whitelist'
                    ? 'border border-primary-500 bg-primary-50 text-primary-700 dark:bg-primary-500/10 dark:text-primary-400'
                    : 'border border-gray-200 bg-white text-gray-600 hover:border-gray-300 hover:text-gray-900 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-400 dark:hover:border-dark-600 dark:hover:text-gray-200'
                ]"
              >
                <svg
              ...
              <button
                ...
                :class="[
                  ...
                  modelRestrictionMode === 'mapping'
                    ? 'border border-purple-500 bg-purple-50 text-purple-700 dark:bg-purple-900/20 dark:text-purple-400'
                    : 'border border-gray-200 bg-white text-gray-600 hover:border-gray-300 hover:text-gray-900 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-400 dark:hover:border-dark-600 dark:hover:text-gray-200'
                ]"
              >
                <svg
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-dark-700">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
                poolModeEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
              ]"
            >
              <span
                :class="[
                  'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white transition-transform duration-150 ease-in-out dark:bg-gray-100',
                  poolModeEnabled ? 'translate-x-5' : 'translate-x-0'
                ]"
              />
            </button>
          </div>
          <div v-if="poolModeEnabled" class="rounded-md border border-blue-200 bg-blue-50 p-3 dark:border-blue-800/40 dark:bg-blue-900/20">
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-dark-700">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
                customErrorCodesEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
              ]"
            >
              <span
                :class="[
          ...
          <div v-if="customErrorCodesEnabled" class="space-y-3">
            <div class="rounded-md border border-amber-200 bg-amber-50 p-3 dark:border-amber-800/40 dark:bg-amber-900/20">
              <p class="text-xs text-amber-700 dark:text-amber-400">
              ...
              <button
                ...
                :class="[
                  ...
                  selectedErrorCodes.includes(code.value)
                    ? 'border border-red-500 bg-red-50 text-red-700 dark:bg-red-900/30 dark:text-red-400'
                    : 'border border-gray-200 bg-white text-gray-600 hover:border-gray-300 hover:text-gray-900 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-400 dark:hover:border-dark-600 dark:hover:text-gray-200'
                ]"
              >
            ...
            <div class="flex flex-wrap gap-1.5">
              <span
                ...
                :key="code"
                class="inline-flex items-center gap-1 rounded-sm border border-red-300 bg-red-50 px-2 py-0.5 font-mono text-xs font-medium text-red-700 dark:border-red-800/40 dark:bg-red-900/30 dark:text-red-400"
              >
                {{ code }}
                <button
                  type="button"
        ...
        <div>
          <label class="flex items-center gap-2 cursor-pointer">
            <input
              ...
              type="checkbox"
              class="rounded-sm border-gray-300 text-primary-600 focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 dark:border-dark-600"
            />
      ...
      <div
        ...
        class="border-t border-gray-200 pt-4 dark:border-dark-700 space-y-4"
      >
        <div class="mb-3">
          <h3 class="input-label mb-0 text-base font-normal tracking-tight">{{ t('admin.accounts.quotaControl.title') }}</h3>
          <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-dark-700 space-y-4">
        <div class="mb-3 flex items-center justify-between">
          <div>
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
              tempUnschedEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="tempUnschedEnabled" class="space-y-3">
          <div class="rounded-md border border-blue-200 bg-blue-50 p-3 dark:border-blue-800/40 dark:bg-blue-900/20">
              <p class="text-xs text-blue-700 dark:text-blue-400">
                <Icon name="exclamationTriangle" size="sm" class="mr-1 inline" :stroke-width="2" />
          ...
          <div class="flex flex-wrap gap-2">
            <button
              ...
              class="rounded-sm border border-gray-200 bg-white px-2.5 py-1 font-mono text-xs font-medium text-gray-600 transition-colors hover:border-gray-300 hover:text-gray-900 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-300 dark:hover:border-dark-600 dark:hover:text-gray-100"
            >
              + {{ preset.label }}
            </button>
          </div>
          ...
          <button
            ...
            class="w-full rounded-sm border border-dashed border-gray-300 px-4 py-2 text-sm text-gray-600 transition-colors hover:border-gray-400 hover:text-gray-700 dark:border-dark-600 dark:text-gray-400 dark:hover:border-dark-500 dark:hover:text-gray-300"
          >
            <svg
              class="mr-1 inline h-4 w-4"
              fill="none"
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
              interceptWarmupRequests ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
            ]"
          >
            <span
              :class="[
      ...
      >
        ...
        <!-- Window Cost Limit -->
        <div class="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-900">
          <div class="mb-3 flex items-center justify-between">
            <div>
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
                windowCostEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-900">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
                sessionLimitEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-900">
          <div class="mb-3 flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
                rpmLimitEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
              ]"
            >
              <span
                :class="[
              ...
              <button type="button" v-for="opt in umqModeOptions" :key="opt.value"
                ...
                :class="[
                  ...
                  userMsgQueueMode === opt.value
                    ? 'border-primary-500 bg-primary-500 text-white'
                    : 'border-gray-300 bg-white text-gray-700 hover:border-gray-400 hover:text-gray-900 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-300 dark:hover:border-dark-600 dark:hover:text-gray-100'
                ]">
                {{ opt.label }}
              </button>
            </div>
        ...
        <div class="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-900">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
                tlsFingerprintEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-900">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
                sessionIdMaskingEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-900">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
                cacheTTLOverrideEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
              ]"
            >
              <span
                :class="[
        ...
        <div class="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-900">
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              :class="[
                'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
                customBaseUrlEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
              ]"
            >
              <span
                :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
              openaiPassthroughEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
              anthropicPassthroughEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
            ]"
          >
            <span
              :class="[
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
              codexCLIOnlyEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
            ]"
          >
            <span
              :class="[
        ...
        <div
          ...
          class="mt-4 flex items-center justify-between border-l-2 border-primary-500 pl-4 dark:border-primary-500"
        >
          <div>
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
              codexCLIOnlyAppServerEnabled ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
            ]"
          >
            <span
              :class="[
      ...
      >
        ...
        <p
          ...
          class="rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-700 dark:border-amber-800/40 dark:bg-amber-900/20 dark:text-amber-300"
        ...
        <div>
          ...
          <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
            <label
              ...
              :key="option.value"
              class="flex cursor-pointer items-center gap-2 rounded-md border border-gray-200 px-3 py-2 text-sm dark:border-dark-700"
            >
              <input
                type="checkbox"
                class="rounded-sm border-gray-300 text-primary-600 focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 dark:border-dark-600"
      ...
      <div>
        <div class="flex items-center justify-between">
          ...
          <button
            ...
            :class="[
              'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-150 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500',
              autoPauseOnExpired ? 'bg-primary-500' : 'bg-gray-300 dark:bg-dark-700'
            ]"
          >
            <span
              :class="[
        ...
        <div v-if="form.platform === 'antigravity'" class="flex items-center gap-2">
          <label class="flex cursor-pointer items-center gap-2">
            <input
              ...
              class="h-4 w-4 rounded-sm border-gray-300 text-primary-500 focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500 dark:border-dark-600"
            />
          ...
          <div class="group relative">
            <span
              class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full border border-gray-300 font-mono text-[10px] text-gray-500 hover:border-gray-400 hover:text-gray-700 dark:border-dark-600 dark:text-gray-400 dark:hover:border-dark-500 dark:hover:text-gray-200"
            >
              ?
            </span>
            <!-- Tooltip（向下显示避免被弹窗裁剪） -->
            <div
              class="pointer-events-none absolute left-0 top-full z-[100] mt-1.5 w-72 rounded-md border border-gray-200 bg-white px-3 py-2 font-mono text-xs text-gray-700 opacity-0 transition-opacity group-hover:opacity-100 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-200"
            >
              {{ t('admin.accounts.mixedSchedulingTooltip') }}
              <div
                class="absolute bottom-full left-3 border-4 border-transparent border-b-white dark:border-b-dark-800"
              ></div>
            </div>
          </div>
        </div>
  ...
  >
    <div class="space-y-6">
      <!-- Setup Guide Section -->
      <div>
        <h3 class="mb-3 font-normal tracking-tight text-gray-900 dark:text-white">
      ...
      <div class="border-t border-gray-200 pt-6 dark:border-dark-600">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs">
            <thead class="border-b border-dashed border-gray-200 bg-gray-50 dark:border-dark-700 dark:bg-dark-900">
              <tr>
                <th class="px-3 py-2 text-left font-mono text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">
