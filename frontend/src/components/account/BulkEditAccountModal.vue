<template>
  ...
  >
    <form id="bulk-edit-account-form" class="space-y-5" @submit.prevent="() => handleSubmit()">
      <!-- Info -->
      <div class="rounded-md border border-blue-200 bg-blue-50 p-4 dark:border-blue-800/40 dark:bg-blue-900/20">
      ...
      <div v-if="isMixedPlatform" class="rounded-md border border-amber-200 bg-amber-50 p-4 dark:border-amber-800/40 dark:bg-amber-900/20">
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
        ...
        >
          <div
            ...
            class="rounded-md border border-amber-200 bg-amber-50 p-3 dark:border-amber-800/40 dark:bg-amber-900/20"
          >
          ...
          <template v-else>
            ...
            <div v-if="modelRestrictionMode === 'whitelist'">
              <div class="mb-3 rounded-md border border-blue-200 bg-blue-50 p-3 dark:border-blue-800/40 dark:bg-blue-900/20">
