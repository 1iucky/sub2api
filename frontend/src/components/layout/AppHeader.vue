    ...
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex shrink-0 items-center gap-2 sm:gap-4">
        ...
        <div class="hidden lg:block">
          <h1 class="text-lg font-normal tracking-tight text-gray-900 dark:text-gray-100">
            {{ pageTitle }}
          </h1>
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        <a
          ...
          class="hidden items-center gap-1.5 rounded-sm px-2.5 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-dark-400 dark:hover:bg-dark-800 dark:hover:text-gray-100 sm:flex"
        >
        ...
        <div
          v-if="user"
          class="group relative hidden items-center gap-1.5 rounded-sm border border-gray-200 bg-white px-2.5 py-1.5 font-mono dark:border-dark-700 dark:bg-dark-900 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="flex items-center gap-2 rounded-sm p-1.5 transition-colors hover:bg-gray-100 dark:hover:bg-dark-800"
            :aria-label="t('common.userMenu')"
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-sm border border-gray-200 bg-gray-100 text-xs font-medium text-gray-600 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-300">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
          ...
          <transition name="dropdown">
            <div v-if="dropdownOpen" class="dropdown right-0 mt-2 w-56">
              ...
              <div class="border-b border-gray-100 px-4 py-2 dark:border-dark-800 sm:hidden">
                ...
                <div class="font-mono text-sm font-medium tabular-nums text-gray-700 dark:text-gray-300">
                  {{ formatHeaderMoney(availableBalance) }}
                </div>
