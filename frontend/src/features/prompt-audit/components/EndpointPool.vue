      ...
      <div class="divide-y divide-gray-100 dark:divide-dark-800">
        ...
        >
          ...
          <div class="min-w-0">
            ...
            <div class="flex items-center gap-1.5 text-xs font-medium" :class="hasCredential(endpoint) ? 'text-gray-600 dark:text-dark-300' : 'text-gray-500 dark:text-dark-400'">
