...
func init() {
	...
	// announcementDescCategory is the schema descriptor for category field.
	announcementDescCategory := announcementFields[4].Descriptor()
	// announcement.DefaultCategory holds the default value on creation for the category field.
	announcement.DefaultCategory = announcementDescCategory.Default.(string)
	// announcement.CategoryValidator is a validator for the "category" field. It is called by the builders before save.
	announcement.CategoryValidator = announcementDescCategory.Validators[0].(func(string) error)
	...
	// usagelogDescDisplayCurrency is the schema descriptor for display_currency field.
	usagelogDescDisplayCurrency := usagelogFields[27].Descriptor()
	// usagelog.DefaultDisplayCurrency holds the default value on creation for the display_currency field.
	usagelog.DefaultDisplayCurrency = usagelogDescDisplayCurrency.Default.(string)
	// usagelog.DisplayCurrencyValidator is a validator for the "display_currency" field. It is called by the builders before save.
	usagelog.DisplayCurrencyValidator = usagelogDescDisplayCurrency.Validators[0].(func(string) error)
	...
	usersubscriptionDescDailyUsageRequests := usersubscriptionFields[12].Descriptor()
	...
	usersubscriptionDescWeeklyUsageRequests := usersubscriptionFields[13].Descriptor()
	...
	usersubscriptionDescMonthlyUsageRequests := usersubscriptionFields[14].Descriptor()
