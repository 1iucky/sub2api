...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		SettingKeyCustomerServiceInviteURL,
		SettingKeyDocURL,
	...
	return &PublicSettings{
		...
		CustomerServiceInviteURL:            strings.TrimSpace(settings[SettingKeyCustomerServiceInviteURL]),
...
type PublicSettingsInjectionPayload struct {
	...
	CustomerServiceInviteURL            string                   `json:"customer_service_invite_url"`
...
func (s *SettingService) GetPublicSettingsForInjection(ctx context.Context) (any, error) {
	...
	return &PublicSettingsInjectionPayload{
		...
		CustomerServiceInviteURL:            settings.CustomerServiceInviteURL,
